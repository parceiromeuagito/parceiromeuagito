...
export const useTeamStore = create<TeamState>()(
    persist(
        (set, get) => ({
            members: [
                { id: '1', name: 'Administrador', role: 'admin', pin: '0000', active: true },
                { id: '2', name: 'Gerente', role: 'manager', pin: '0000', active: true },
                { id: '3', name: 'Caixa', role: 'cashier', pin: '0000', active: true },
            ],
            addMember: (member) => set((state) => ({
                members: [...state.members, { ...member, id: Date.now().toString(), active: true }]
            })),
