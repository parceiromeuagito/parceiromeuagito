...
const CreativeStudio = () => {
  ...
  const potentialReach = Math.floor(
    radius * 1250 * (Math.random() * 0.5 + 0.8),
  );
  const estimatedCost =
    budgetType === "fixed"
      ? radius <= 2
  ...
  useEffect(() => {
    ...
    const draft = CreativeAIService.generateCampaign(
      "rainy_day",
      config.businessTypes[0] || "delivery",
      "Combo Especial",
    );
    setCampaign(draft);
    ...
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-900 dark:to-blue-900 p-8 rounded-2xl text-white shadow-lg">
        ...
        <p className="text-white/90">
          Crie campanhas de marketing profissionais em minutos com inteligência
          artificial
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          {
            type: "rainy_day" as InsightType,
            label: "Dia Chuvoso",
            icon: "☔",
            color: "bg-blue-500",
          },
          {
            type: "slow_sales" as InsightType,
            label: "Vendas Baixas",
            icon: "🔥",
            color: "bg-orange-500",
          },
          {
            type: "holiday" as InsightType,
            label: "Feriado",
            icon: "🎉",
            color: "bg-purple-500",
          },
          {
            type: "low_ticket" as InsightType,
            label: "Ticket Baixo",
            icon: "💰",
            color: "bg-green-500",
          },
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    value={campaign.copy}
                    onChange={(e) =>
                      setCampaign({ ...campaign, copy: e.target.value })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCampaign({ ...campaign, imagePrompt: e.target.value })
                    }
                    className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 outline-none"
                ...
                {campaign.suggestedDiscount > 0 && (
                  <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                    <p className="text-sm text-orange-800 dark:text-orange-200">
                      💡 <strong>Sugestão IA:</strong> Desconto de{" "}
                      {campaign.suggestedDiscount}% para máximo impacto
                    </p>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                >
                  <div className="flex items-center gap-2 mb-4 border-b border-gray-100 pb-3">
                    ...
                    <div>
                      <p className="font-bold text-sm leading-none text-gray-900">
                        Meu Agito
                      </p>
