      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          <h2 className="text-2xl font-bold text-white">
            Gerenciar {context.itemLabel}s
          </h2>
          <p className="text-zinc-400">
            Adicione, edite ou remova itens do seu catálogo.
          </p>
        </div>
          ...
          {filteredItems.length === 0 ? (
            ...
            >
              ...
              <p className="text-zinc-500 max-w-md">
                Não encontramos nada com os filtros atuais. Tente buscar por
                outro termo ou adicione um novo item.
              </p>
            </motion.div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <h3
                      className="font-bold text-white text-lg mb-1 line-clamp-1"
                      title={item.name}
                    >
                      {item.name}
                    </h3>
                    ...
                    <div className="pt-4 border-t border-zinc-800 flex items-center gap-4 text-xs text-zinc-500 font-medium">
                      ...
                      <div
                        className={`ml-auto flex items-center gap-1.5 ${item.available ? "text-green-400" : "text-red-400"}`}
                      >
                        <span
