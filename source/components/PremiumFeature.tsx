...
const PremiumFeature = ({
  ...
  return (
    <div
      className={`relative group overflow-hidden rounded-xl border border-gray-200 bg-gray-50 ${className}`}
    >
      <div className="absolute inset-0 bg-gray-100/60 backdrop-blur-[1px] z-10 flex flex-col items-center justify-center p-4 text-center transition-opacity">
        ...
        <p className="text-xs text-gray-500 mb-3 max-w-[200px]">
          Disponível no plano{" "}
          <span className="uppercase font-bold text-blue-600">{minPlan}</span>
        </p>
        <Link
          to="/settings"
