...
const Sidebar = ({
  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: "/dashboard/pos",
          permission: "pos:view" as Permission,
        },
        {
          icon: MessageCircle,
          label: "Mensagens",
      ...
      items: [
        {
          ...
          path: "/dashboard/menu",
          permission: "catalog:view" as Permission,
        },
        {
          icon: Users,
          label: "Clientes",
        ...
        },
        {
          ...
          badgeText: "IA",
          permission: "creative:view" as Permission,
        },
      ],
    },
    {
  ...
  const getRoleIcon = () => {
    ...
    switch (currentUser.role) {
      ...
      case "manager":
        return <UserCog className="w-3 h-3 text-purple-400" />;
      case "cashier":
        ...
        >
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-zinc-200 dark:border-zinc-800">
            ...
            >
              ...
              <div className={cn(isCollapsed && "lg:hidden")}>
                <h1 className="font-bold text-sm text-zinc-900 dark:text-white">
                  {context.label}
                </h1>
                    ...
                    return (
                      ...
                      >
                        ...
                        {item.badge && item.badge > 0 && (
                          <Badge
                            className={cn(
                              "h-5 w-5 flex items-center justify-center p-0 text-xs bg-primary text-white",
                              isCollapsed && "lg:hidden",
                            )}
                          >
                            {item.badge}
                        ...
                        {item.badgeText && (
                          <Badge
                            className={cn(
                              "px-2 py-0.5 text-[10px] bg-gradient-to-r from-purple-500 to-blue-500 text-white font-bold",
                              isCollapsed && "lg:hidden",
                            )}
                          >
                            {item.badgeText}
          ...
          <div className="border-t border-zinc-200 dark:border-zinc-800 p-2 space-y-2">
            ...
            <Tooltip>
              ...
              >
                {cashRegister.isOpen
                  ? "Caixa Aberto - Clique para gerenciar"
            ...
            <div
              className={cn(
                "px-3 py-3 rounded-lg bg-zinc-50 dark:bg-zinc-900 mb-2",
                isCollapsed && "lg:hidden",
              )}
            >
            ...
            >
              ...
              <span className={cn("ml-2 text-sm", isCollapsed && "lg:hidden")}>
                Sair
              </span>
            </Button>
          </div>
