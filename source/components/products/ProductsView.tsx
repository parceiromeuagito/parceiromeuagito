...
import { Search, Package, UtensilsCrossed, Bed, Ticket, Calendar, Armchair, ShoppingBag } from 'lucide-react';
                    ...
                    {Object.entries(PRODUCT_CATEGORIES).map(([key, cat]) => {
                        ...
                        return (
                            <TabsTrigger key={key} value={key} className="flex gap-2">
                                ...
                                {cat.name}
                                <Badge variant="secondary" className="ml-1">{productCounts[key] || 0}</Badge>
                            </TabsTrigger>
                        );
                    })}
                </TabsList>
                        ...
                        <div className="flex flex-col items-center justify-center h-64">
                            <EmptyState
                                ...
                                action={{
                                    ...
                                    onClick: () => console.log("Abrir modal de adicionar produto") // Placeholder
                                }}
                            />
                        </div>
                    )}
