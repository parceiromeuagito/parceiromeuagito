...
import { Sparkles, TrendingUp, TrendingDown, Minus, Lightbulb, Wand2 } from 'lucide-react';
...
export function AIInsightsCard() {
    ...
    const [selectedInsightType, setSelectedInsightType] = useState<InsightType>('rainy_day');
                ...
                <Card className="bg-white dark:bg-zinc-900/50 border-gray-200 dark:border-zinc-800 relative overflow-hidden">
                    ...
                    <CardContent>
                        <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-gray-900 dark:text-white">Desbloqueie a Inteligência Artificial</h3>
                                <p className="text-sm text-gray-500 dark:text-zinc-500 max-w-xs mx-auto mt-1">
                                    Receba previsões de vendas e dicas de otimização exclusivas no plano Enterprise.
                                </p>
                            </div>
                        </div>
                    </CardContent>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-zinc-900 dark:to-zinc-900/80 border-gray-200 dark:border-zinc-800 shadow-lg shadow-purple-100/20 dark:shadow-purple-900/5">
                <CardHeader className="pb-2">
                    <CardTitle className="flex items-center justify-between">
                        ...
                        <Badge variant="outline" className="border-purple-300 dark:border-purple-500/30 text-purple-700 dark:text-purple-400 bg-purple-100 dark:bg-purple-500/10">
                            Beta
                        </Badge>
                    </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                    ...
                    <div className="flex items-end justify-between">
                        <div>
                            <p className="text-sm text-gray-600 dark:text-zinc-400 mb-1">Previsão para Hoje</p>
                    ...
                    <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-zinc-800">
                        ...
                        <ul className="space-y-2">
                            {insights.optimizations.map((opt, i) => (
                                <li key={i} className="flex items-center justify-between bg-gray-100 dark:bg-zinc-800/30 p-2 rounded-lg">
                                    <div className="flex items-start gap-2">
                                        <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-600 dark:bg-purple-500 shrink-0" />
                                        <span className="text-xs text-gray-700 dark:text-zinc-400">{opt}</span>
                                    </div>
