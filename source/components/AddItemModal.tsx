...
const AddItemModal = ({ isOpen, onClose }: AddItemModalProps) => {
  ...
  const handleSubmit = () => {
    ...
    const newItem: CatalogItem = {
      ...
      ...(selectedType === "hotel" && capacity
        ? { capacity: parseInt(capacity) }
        : {}),
      ...(selectedType === "scheduling" && duration
        ? { duration: parseInt(duration) }
        : {}),
      ...((selectedType === "tickets" || selectedType === "ecommerce") && stock
      ...
      >
        ...
        >
          ...
          <div className="p-6 border-b border-gray-100 dark:border-zinc-800 flex justify-between items-center bg-gray-50 dark:bg-zinc-950">
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-zinc-400">
                Preencha os dados para cadastrar no catálogo.
              </p>
            </div>
            <button
              onClick={onClose}
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-900/30">
                ...
                <div className="relative">
                  ...
                  <select
                    value={selectedType}
                    onChange={(e) =>
                      setSelectedType(e.target.value as BusinessType)
                    }
          ...
          <div className="p-4 border-t border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950 flex justify-end gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2.5 text-gray-600 dark:text-zinc-400 font-medium hover:bg-gray-200 dark:hover:bg-zinc-800 rounded-lg transition-colors"
            >
              Cancelar
            </button>
            <button
              onClick={handleSubmit}
              className="px-6 py-2.5 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20 flex items-center gap-2"
            >
