...
const SecurityGateModal = ({ isOpen, onClose, onSuccess, requiredPermission }: SecurityGateModalProps) => {
                    ...
                    >
                        <div className="p-6 text-center">
                            ...
                            <p className="text-sm text-zinc-400 mb-6">
                                Esta ação requer autorização.<br />
                                ...
                                {[0, 1, 2, 3].map((i) => (
                                    <div
                                        ...
                                        className={`w-4 h-4 rounded-full transition-all duration-200 ${i < pin.length
                                            ? success ? 'bg-green-500 scale-110' : error ? 'bg-red-500 scale-110' : 'bg-primary scale-110'
