...
```typescript
// Tipos de Negócio
type BusinessType = 'delivery' | 'reservation' | 'hotel' | 'tickets' | 'scheduling' | 'ecommerce';

// Status de Pedido
type OrderStatus = 'pending' | 'accepted' | 'preparing' | 'ready' | 'delivering' | 'completed' | 'cancelled' | 'rejected' | 'returned' | 'partially_returned';

// Planos
type PlanTier = 'starter' | 'pro' | 'enterprise';

// Fonte do Pedido
type OrderSource = 'online' | 'counter' | 'marketplace_ifood' | 'marketplace_booking' | 'marketplace_rappi';
...
type PaymentMethod = 'credit_card' | 'debit_card' | 'pix' | 'cash' | 'online' | 'split';
```
...
*Documento 100% COMPLETO - Análise de todos os 86 arquivos do projeto.*
