...
test.describe('Edge Cases - Casos Extremos', () => {
    ...
    test('EDGE01 - Deve lidar com nome muito longo no produto', async ({ page }) => {
    ...
    test('EDGE05 - Deve lidar com carrinho vazio no POS', async ({ page }) => {
        ...
        const finalizeBtn = page.locator('button').filter({ hasText: /finalizar/i }).first();
    ...
    test('EDGE06 - Deve lidar com valor recebido menor que total', async ({ page }) => {
        await page.goto('/dashboard/pos');
        await page.waitForTimeout(1000);
        ...
        if (await product.count() > 0) {
            ...
            const cashBtn = page.locator('button').filter({ hasText: /dinheiro/i }).first();
    ...
    test('EDGE07 - Deve lidar com múltiplas abas abertas simultaneamente', async ({ page, context }) => {
    ...
    test('EDGE10 - Deve lidar com caracteres especiais em busca', async ({ page }) => {
        await page.goto('/dashboard/menu');
        await page.waitForTimeout(1000);
    ...
    test('EDGE11 - Deve lidar com upload de arquivo muito grande', async ({ page }) => {
        await page.goto('/dashboard/menu');
        await page.waitForTimeout(1000);
    ...
    test('EDGE15 - Deve lidar com muitos pedidos simultâneos', async ({ page }) => {
        await page.goto('/dashboard/orders');
        await page.waitForTimeout(1000);
...
test.describe('Performance - Otimização e Carga', () => {
    ...
    test('PERF01 - Dashboard deve carregar em menos de 3 segundos', async ({ page }) => {
    ...
    test('PERF05 - Animações devem ser fluidas (60fps)', async ({ page }) => {
        ...
        const advanceBtn = page.locator('button').filter({ hasText: /avançar/i }).first();
    ...
    test('PERF06 - Filtros devem atualizar instantaneamente', async ({ page }) => {
        await page.goto('/dashboard/orders');
        await page.waitForTimeout(1000);

        const filterBtn = page.locator('button').filter({ hasText: /todos|delivery|pickup/i }).first();
    ...
    test('PERF08 - Não deve ter memory leaks em navegação prolongada', async ({ page }) => {
        const routes = [
            '/dashboard',
            '/dashboard/orders',
            '/dashboard/pos',
